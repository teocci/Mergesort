package random; /******************************************************************************
 *  Compilation:  javac random.SecureShuffle.java
 *  Execution:    java random.SecureShuffle < list.txt
 ...
 *
 *  % java random.SecureShuffle < cards.txt
 *  6H
 *  9C
 *  8H
 *  7C
...
public class SecureShuffle {
    public static void main(String[] args) {
        ...
        // read in the data
        In strings = new In(args[0]);
        String [] a = strings.readAllStrings();
